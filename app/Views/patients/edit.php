                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <select name="phic_status" id="phic_status" class="form-select" required>
                                ...
                                <option value="Member" <?= ($patient['phic_status'] ?? '') === 'Member' ? 'selected' : '' ?>>Member (Direct/Indirect)</option>
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <select name="education_attainment" id="education_attainment" class="form-select">
                                ...
                                <?php foreach (['No Schooling', 'Elementary', 'High School', 'Vocational', 'College / Post-Graduate'] as $edu): ?>
